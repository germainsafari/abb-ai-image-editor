...
export default function DownloadStep({
  ...
  return (
    <div className="flex flex-col h-full">
      ...
      <div className="flex-1 min-h-0 overflow-y-auto overflow-x-hidden flex flex-col" style={{ gap: '40px' }}>
        {/* Title */}
        <h2
      ...
      <div className="flex-shrink-0 flex flex-wrap items-center justify-between pt-6" style={{ gap: '12px' }}>
        <button
          onClick={onCancel}
